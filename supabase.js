/**
 * ═══════════════════════════════════════════════════════
 *  AQUAGESTOR — Módulo Supabase Compartilhado v1.0
...
(function () {
  ...
  if (!URL_BASE || !ANON_KEY) {
    ...
    if (pg !== 'index.html' && pg !== '') {
      window.location.href = 'index.html?from=' + encodeURIComponent(pg);
    }
  }
  ...
  var SB = {
    ...
    /* ── user_data (dados do app principal, lidos pelo colaborador) ── */
    userData: {
